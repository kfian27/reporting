<?php
	class Mlaporan extends CI_Model {
        ...
        function get_tanggal($tgl1 ='',$tgl2 ='',$param1=''){
        	$sql = "SELECT NM_HEADER, COUNT(NM_HEADER) AS jumlahnya FROM (SELECT NM_HEADER, TGL_OL, KD_SKPD FROM DATA_PEMOHON, MIJIN WHERE MONITORINGSSW.MIJIN.KD_IJIN = MONITORINGSSW.DATA_PEMOHON.KD_IJIN AND TGL_OL BETWEEN TO_DATE('$tgl1', 'yyyy-mm-dd') AND TO_DATE('$tgl2', 'yyyy-mm-dd') AND KD_SKPD LIKE '%$param1' AND KD_SKPD NOT LIKE '1$param1') where NM_HEADER!=' ' GROUP BY NM_HEADER ORDER BY NM_HEADER";
