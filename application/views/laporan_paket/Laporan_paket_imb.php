                          ...
                          <table id="coba-table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><?php if($a==1){?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/proses_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/IMB/<?php echo $prosesnya_imb;?>' <?php if($prosesnya_imb==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $prosesnya_imb;$JUMLAHNYA = $JUMLAHNYA + $prosesnya_imb;?></a><?php }
                                    else{?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/proses_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/SKRK/<?php echo $prosesnya_skrk;?>' <?php if($prosesnya_skrk==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $prosesnya_skrk;$JUMLAHNYA = $JUMLAHNYA + $prosesnya_skrk;?></a><?php }?>
                                  </td>
                                 <td><?php if($a==1){?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/pending_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/IMB/<?php echo $pendingnya_imb;?>' <?php if($pendingnya_imb==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $pendingnya_imb;$JUMLAHNYA = $JUMLAHNYA + $pendingnya_imb;?></a><?php }
                                    else{?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/pending_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/SKRK/<?php echo $pendingnya_skrk;?>' <?php if($pendingnya_skrk==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $pendingnya_skrk;$JUMLAHNYA = $JUMLAHNYA +$pendingnya_skrk;?></a><?php }?>
                                  </td>
                                  <td><?php if($a==1){?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>tolak_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/IMB/<?php echo $tolaknya_imb;?>' <?php if($tolaknya_imb==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $tolaknya_imb;$JUMLAHNYA = $JUMLAHNYA + $tolaknya_imb;?></a><?php }
                                    else{?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/tolak_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/SKRK/<?php echo $tolaknya_skrk;?>' <?php if($tolaknya_skrk==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $tolaknya_skrk;$JUMLAHNYA = $JUMLAHNYA + $tolaknya_skrk;?></a><?php }?>
                                  </td>
                                  <td><?php if($a==1){?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/selesai_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/IMB/<?php echo $selesainya_imb;?>' <?php if($selesainya_imb==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $selesainya_imb;$JUMLAHNYA = $JUMLAHNYA + $selesainya_imb;?></a><?php }
                                    else{?>
                                   <a type='button' data-title='button' href='<?php echo base_url();?>laporan_paket/selesai_detail/<?php echo $tgl_mulai;?>/<?php echo $tgl_akhir;?>/<?php echo $paketnya;?>/SKRK/<?php echo $selesainya_skrk;?>' <?php if($selesainya_skrk==0)echo "class='btn btn-default pull-right' disabled";else echo "class='btn btn-primary pull-right'";?>><?php echo $selesainya_skrk;$JUMLAHNYA = $JUMLAHNYA + $selesainya_skrk;?></a><?php }?>
                                  </td>
