      ...
      <div class="right_col" role="main" id="view">
        ...
        <?php
            ...
            for ($b=1; $b < 13 ; $b++) { 
              $dash_selesai = $this->mlaporan_paket->get_dasboard_gabungan_selesai($tahunnya,$judul_grafik,$b);
              $dash_proses = $this->mlaporan_paket->get_dasboard_gabungan_proses($tahunnya,$judul_grafik,$b);
              $dash_pending = $this->mlaporan_paket->get_dasboard_gabungan_pending($tahunnya,$judul_grafik,$b);
              $dash_tolak = $this->mlaporan_paket->get_dasboard_gabungan_tolak($tahunnya,$judul_grafik,$b);
              if (!$dash_selesai) {
                $datanya[] = 0;
              }
              else{
